...
- [5. API Description](#5-api-description)
  ...
  - [5.2. API Endpoint and Operation Description](#52-api-endpoint-and-operation-description)
    - [5.2.1. Appointment API Endpoints](#521-appointment-api-endpoints)
      ...
      - [5.2.1.2. Buyer side Appointment API Endpoints](#5212-buyer-side-appointment-api-endpoints)
  ...
  - [5.4. Providing the place information](#54-providing-the-place-information)
...
- [6. API Interactions and Flows](#6-api-interactions-and-flows)
  - [6.1. Use Case 7: Search Appointment Timeslot](#61-use-case-7-search-appointment-timeslot)
    ...
    - [6.1.2. Create Appointment Timeslot - Request](#612-create-appointment-timeslot---request)
    - [6.1.3. Create Appointment Timeslot - Response](#613-create-appointment-timeslot---response)
...
- [7. API Details](#7-api-details)
  ...
  - [7.2. Management API Data model](#72-management-api-data-model)
    ...
    - [7.2.3. Common](#723-common)
      ...
      - [7.2.3.3. `enum` MEFBuyerSellerType](#7233-enum-mefbuyersellertype)
      - [7.2.3.4. Type MEFByteSize](#7234-type-mefbytesize)
      - [7.2.3.5. Type Note](#7235-type-note)
      - [7.2.3.6. Type RelatedContactInformation](#7236-type-relatedcontactinformation)
      - [7.2.3.7. Type RelatedEntity](#7237-type-relatedentity)
      - [7.2.3.8. Type TimeDuration](#7238-type-timeduration)
      - [7.2.3.9. `enum` TimeDurationUnits](#7239-enum-timedurationunits)
      - [7.2.3.10. Type TimePeriod](#72310-type-timeperiod)
      - [7.2.3.11. Type TimeSlot](#72311-type-timeslot)
    - [7.2.4. Place representation](#724-place-representation)
      ...
      - [7.2.4.3. Type ContactInformation](#7243-type-contactinformation)
      - [7.2.4.4. Type GeographicAddress\_Query](#7244-type-geographicaddress_query)
      - [7.2.4.5. Type FieldedAddressRepresentation](#7245-type-fieldedaddressrepresentation)
      - [7.2.4.6. Type FormattedAddressRepresentation](#7246-type-formattedaddressrepresentation)
      - [7.2.4.7. Type GeographicPointRepresentation](#7247-type-geographicpointrepresentation)
      - [7.2.4.8. Type LabelRepresentation](#7248-type-labelrepresentation)
      ...
      - [7.2.4.11. Type SubUnit](#72411-type-subunit)
    - [7.2.5. Notification registration](#725-notification-registration)
      - [7.2.5.1. EventSubscription](#7251-eventsubscription)
      - [7.2.5.2. EventSubscriptionInput](#7252-eventsubscriptioninput)
  - [7.3. Notification API Data Model](#73-notification-api-data-model)
    - [7.3.1. Common Notification](#731-common-notification)
      - [7.3.1.1. Event](#7311-event)
    - [7.3.2. Appointment Notification.](#732-appointment-notification)
      - [7.3.2.1. Type AppointmentAttributeValueChangeEvent](#7321-type-appointmentattributevaluechangeevent)
      - [7.3.2.2. Type AppointmentAttributeValueChangeEventPayload](#7322-type-appointmentattributevaluechangeeventpayload)
      - [7.3.2.3. Type AppointmentStatusChangeEvent](#7323-type-appointmentstatuschangeevent)
      - [7.3.2.4. Type AppointmentStatusChangeEventPayload](#7324-type-appointmentstatuschangeeventpayload)
    - [7.3.3. WorkOrder Notification.](#733-workorder-notification)
      - [7.3.2.1. Type WorkOrderAppointmentRequiredEvent](#7321-type-workorderappointmentrequiredevent)
      - [7.3.2.2. Type WorkOrderCreateEvent](#7322-type-workordercreateevent)
      - [7.3.2.3. Type WorkOrderEventPayload](#7323-type-workordereventpayload)
      - [7.3.2.4. Type WorkOrderStateChangeEvent](#7324-type-workorderstatechangeevent)
      - [7.3.2.5. Type WorkOrderStateChangeEventPayload](#7325-type-workorderstatechangeeventpayload)
...
_Trouble Ticketing Requirements and Use Cases_ [[MEF 113](#8-references)]. This
...
- [`productApi/workforce/appointment/appointmentManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/aaa03d484f98664a5a14f4f54f47b675d7efb3b8/productApi/workforce/appointment/appointmentManagement.api.yaml)
- [`productApi/workforce/appointment/appointmentNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/aaa03d484f98664a5a14f4f54f47b675d7efb3b8/productApi/workforce/appointment/appointmentNotification.api.yaml)
- [`productApi/workforce/workorder/workorderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/aaa03d484f98664a5a14f4f54f47b675d7efb3b8/productApi/workforce/workorder/workorderManagement.api.yaml)
- [`productApi/workforce/workorder/workorderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/aaa03d484f98664a5a14f4f54f47b675d7efb3b8/productApi/workforce/workorder/workorderNotification.api.yaml)
...
- [`productApi/workforce/appointment/appointmentManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/83d6edd0c70386058a9af6e677c069b498671da7/productApi/workforce/appointment/appointmentManagement.api.yaml)
- [`productApi/workforce/appointment/appointmentNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/83d6edd0c70386058a9af6e677c069b498671da7/productApi/workforce/appointment/appointmentNotification.api.yaml)
- [`productApi/workforce/workorder/workorderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/83d6edd0c70386058a9af6e677c069b498671da7/productApi/workforce/workorder/workorderManagement.api.yaml)
- [`productApi/workforce/workorder/workorderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/83d6edd0c70386058a9af6e677c069b498671da7/productApi/workforce/workorder/workorderNotification.api.yaml)
...
this document by reference and are not repeated in the Table 2:
...
defined in MEF 113 _Trouble Ticketing Requirements and Use Cases_
[[MEF 113](#8-references)]. MEF 113 defines use cases that cover Trouble Ticket,
Incident, Appointment and WorkOrder. This API and Developer Guide covers the
Appointment and WorkOrder related use cases. The Trouble Ticket and Incident use
cases are covered by [MEF 124](#8-references) LSO Cantata and LSO Sonata Trouble
Ticket Management API - Developer Guide.
...
cases that are defined in [[MEF 113](#8-references)]. The API definition builds
...
[[TMF697](#8-references)]. It is also related to _Cantata and LSO Sonata Trouble
Ticket Management API - Developer Guide_ [[MEF 124](#8-references)], which
covers outstanding Trouble Ticket use cases are described in MEF 113.
...
[[MEF 113](#8-references)] in section 7. This picture aims to help understand
...
create, retrieve, modify an Appointment and register for Notifications. The
...
#### 5.2.1.2. Buyer side Appointment API Endpoints
...
| `POST /listener /appointmentAttributeValueChangeEvent` | The Seller sends a notification regarding an Appointment to the Buyer indicating one of the following Appointment Notification Types have occurred: `AppointmentAttribute ValueChangeEvent` | UC 20. Send Appointment Notification |

**Table 5. Buyer side mandatory Appointment API endpoints**

**[R2]** The Buyer **MUST** support Appointment API endpoints listed in Table 5.
[MEF113 R3]
...
The following API endpoints are implemented by the Seller and allow the Buyer to
retrieve WorkOrders and register for Notifications. The endpoints and
...
The following API endpoints are implemented by the Seller and allow the Buyer to
register and send WorkOrder Notifications. The endpoints and corresponding data
...
| `POST /listener /workOrderAttributeValueChangeEvent` | The Seller sends a notification regarding an Appointment to the Buyer indicating one of the following WorkOrder Notification Types has occurred: `workOrder StateChangeEvent`         | UC 22. Send WorkOrder Notification |
| `POST /listener /workOrderAppointmentRequiredEvent`  | The Seller sends a notification regarding an Appointment to the Buyer indicating one of the following WorkOrder Notification Types has occurred: `workOrder AppointmentRequiredEvent` | UC 22. Send WorkOrder Notification |
...
## 5.4. Providing the place information

When required the place information can be provided with the
`RelatedPlaceRefOrQuery` type, which is presented in Figure 6.

![referring a place](media/relatedPlace.png)

**Figure 6. Data model - referring to a place**

The `role` defines the function that the place plays for given context.

`contact` provides additional information about the person to contact to get
access to this place in case such access is required.
...
One or more of these representations can be used to describe a single place.
...
The structure of the HTTP payloads exchanged via Trouble Ticket API endpoints is
...
and flows. It starts with Figure 7 and Table 8, presenting a list and short
description of all business use cases then presents the variants of end-to-end
interaction flows, and in the following subchapters describes the API usage flow
...
Figure 7 presents an example of an end-to-end flow that shows dependencies
between all the domains:

![End-to-End API Flows](media/useCaseWorkOrder.png)

**Figure 7. End-to-End API Flows**
...
- (5-6)The Seller decides that a WorkOrder with an Appointment is needed to
  resolve the issue. The Seller creates a WorkOrder in state `open` and sends a
  `workOrderCreateEvent`.
- (7-8)Workorder state changes if an Appointment is needed (WorkOrder has
  `appointmentRequired=true`) causing the Trouble Ticket status to change to
  `pending`
...
- (31-32) If there are no additional open WorkOrders for a Trouble Ticket, then
  the WorkOrder state change causes the Trouble Ticket status change back to
  `resolved`.
...
sections 7 and 8 of MEF 113 [[MEF 113](#8-references)].
...
**Figure 8. Use Case 7: Appointment Timeslot create request flow**

The Buyer sends a request with a `SearchTimeSlot_Create` type in the body.

### 6.1.2. Create Appointment Timeslot - Request

Figure 9 presents the data model of the Appointment Timeslot. The model of the
...
**Figure 9. Create Appointment Timeslot Model**
...
**[R9]** The Buyer's request **MUST** include the following attributes: [MEF113
R71]

- `workOrder`
- `requestedTimeSlot`

### 6.1.3. Create Appointment Timeslot - Response
...
**[R10]** The Seller **MUST** return an error `Error422` if any of the included
attributes in the Buyer's request are invalid. [MEF113 R73]

**[R11]** The Seller's response **MUST** return an empty list of
`availableTimeSlot` if no Seller resources are available for an appointment that
falls within any of the `requestedTimeSlot`. [MEF113 R74]

**[R12]** The Seller's response **MUST** include one or more
...
**Figure 10. Use Case 8: Appointment create request flow**
...
From this point, the Appointment is ready for further processing. The Buyer must
track the progress of the process by subscribing for notifications (see
[chapter 6.9](#69-use-case-19-register-for-appointment-notifications)). The flow
example with the use of Notifications is presented in Figure 11.

![Appointment Notifications](media/useCase9Notification.png)

**Figure 11. Appointment progress tracking - Notifications**
...
Figure 12 presents the data model of the Appointment. The model of the request
message (`Appointment_Create`) is a subset of the `Appointment` model and
contains only attributes that can (or must) be set by the Buyer. The Seller then
...
**Figure 12. Create Appointment Model**
  ...
  "attachment": [
    {
      ...
      "source": "buyer",
      "url": "https://buyer.mef.com/documents/00000000-0000-1111-2222-000000001111"
    }
  ],
...
**[R13]** The Buyer's request **MUST** include the following attributes: [MEF113
R78]
...
**[R14]** The Seller **MUST** return an error `Error422` if the `validFor` is
not valid. [MEF113 R81]

**[R15]** The Seller **MUST** return an error `Error422` if a Seller technician
is not available for an appointment at the `relatedPlace` for the specified
`requestedTimeSlot`. [MEF113 R82]

**[R16]** The Seller's response **MUST** include the Buyer following attributes.
[MEF113 R83-R84]
...
**[R17]** The Seller **MUST** set the appointment `status` to `confirmed`.
[MEF113 R85]

**[R18]** The Seller **MUST** return an error `Error422` if the `workOrder`
references a workOrder that contains a reference to an appointment with `status`
of `confirmed` or `inProgress`. [MEF113 R86]

**[R19]** The Seller **MUST** return an error `Error422` if the related
workOrder `state` is not `open`. [MEF113 R87]

**[R20]** After creating the Appointment instance, the Seller **MUST** add the
`appointment.id` to the `appointment` attribute of the related WorkOrder.
[MEF113 R88]

**[R21]** The Seller **MUST** set the `appointmentRequired` attribute to `false`
in the related WorkOrder. [MEF113 R89]

**[R22]** The Seller **MUST** set the related WorkOrder `state` to `planned`.
[MEF113 R90]

**[R23]** The Seller **MUST** update the `status` of the Trouble Ticket, for
which this Appointment was created to `inProgress`. [MEF113 R91]

### 6.2.4. Appointment - Lifecycle

Figure 13 presents the Appointment state machine:

![Appointment State Machine](media/appointmentStates.png)

**Figure 13. Appointment State Machine**

After receiving the request, the Seller performs a validation of the message. If
any problem is found an Error response is provided. If the validation passes a
response is provided with `Appointment` in `confirmed` status. When
...
**[R24]** The Seller **MUST** support all Appointment `status` and associated
transitions. [MEF113 R173]

**[R25]** If the Seller wants to reschedule an `Appointment`, the **MUST**
update the Appointment `status` to `cancelled` and request the Buyer to schedule
a new `Appointment` by setting `validFor` to TRUE in the related `WorkOrder`.
[MEF113 R174]

**[R26]** The Seller **MUST** send an `AppointmentStatusChangeEvent` whenever an
Appointment `status` change has occurred. [MEF113 R175]

**[R27]** The Seller **MUST** send an `AppointmentAttributeValueChangeEvent`
...
**[R28]** The Seller **MUST** return the following attributes: [MEF113 R93]
...
**[R29]** The Seller response **MUST** include all Appointments with an
...
**Figure 14. Use Case 9: Retrieve Appointment List - Model**
...
**[R30]** The Buyer **MUST** include the `id`. [MEF113 R105]

**[R31]** In case `id` does not allow to find a `Appointment` instance in
Seller's system, an error `Error404` **MUST** be returned. [MEF113 R96]

**[R32]** The Seller's response **MUST** include the following attributes:
[MEF113 R98]
...
- `workOrder`
- `relatedContactInformation`:
  - item with `role=appointmentPlaceContact`
  - item with `role=buyerAppointmentContact`
  - item with `role=sellerAppointmentContact`

**[R33]** The Seller's response **MUST** include all of the following optional
...
Figure 15 presents the model used in the PATCH request. The Seller responds with
a `Appointment` type.
...
**[R34]** The Buyer **MUST** include at least one of the following attributes:
[MEF113 R101]
...
**[R35]** The Buyer **MUST NOT** change any of the following attributes: [MEF113
R102]
...
**[R36]** The Buyer **MUST NOT** change the `relatedContactInformation`
attribute. [MEF113 R103]

**[R37]** The Seller **MUST** return an error `Error404` if the Appointment with
the `id` is not found. [MEF113 R104]

**[R38]** The Seller **MUST** return an error `Error422` if the `status` of the
Appointment to be updated is not `confirmed`. [MEF113 R105]

**[R39]** If `validfor` was included by the Buyer, the Seller **MUST** return an
error `Error422` if the `validfor` is not valid. [MEF113 R106]

**[R40]** If an `validfor` was included by the Buyer, the Seller **MUST** return
an error `Error422` if a Seller technician is not available for an appointment
at the `relatedPlace` for the specified `availableTimeSlot`. [MEF113 R107]

**[R41]** To add a new `note` the Buyer **MUST** append it to the existing
`note` list. [MEF113 R108]

**[R42]** To add a new `attachment` the Buyer **MUST** append it to the existing
`attachment` list. [MEF113 R109]
...
**Figure 16. Cancel Appointment Flow**
...
**[R43]** The Seller **MUST** return an error `Error404` if the Appointment `id`
is not found. [MEF113 R112]
...
**[R48]** The Seller **MUST** set the Appointment `status` to `cancelled`.
[MEF113 R117]

## 6.7. Use Case 13: Retrieve WorkOrder List

**[O4]** The Buyer **MAY** use `GET /workOrder` operation with desired filtering
criteria: [MEF113 O18]
...
specified in URI query format [RFC3986](#8-references).
...
`inProgress`. Additionally, the Buyer asks only for a first (`offset=0`) pack of
10 results (`limit=10`) to be returned. The correct response (HTTP code `200`)
in the response body contains a list of `WorkOrder_Find` objects matching the
criteria. To get more details (e.g. the item level information), the Buyer has
to query a specific `WorkOrder` by `id`.
...
**Figure 17. Use Case 13: Retrieve WorkOrder List - Model**
...
**[R50]** In case `id` does not allow to finding a `WorkOrder` instance, an
...
Figure 18 presents the model of the WorkOrder.

![Use Case 14: WorkOrder - Model](media/useCase14WorkOrderModel.png)

**Figure 18. Use Case 14: WorkOrder - Model**

Table 10 presents the mapping between the API `state` names and the MEF 113
...
Figure 19 presents the WorkOrder state machine:

![WorkOrder state Machine](media/useCase14WorkOrderStates.png)

**Figure 19. WorkOrder State Machine**
...
```json
{
  ...
  "relatedContactInformation": [
    {
      "emailAddress": "technical.contact@seller.mef.com",
...
The usage of a combination of these attributes fulfills the [ME113 R125], [ME113
R126], [ME113 R127] requirements.
...
**Figure 20. Use Case 20. Appointment Notification Data Model**
...
ones in MEF 113. The inconsistencies are caused by using the TMF event types as
...
explicit respective Create Notification type. The next notification must be sent
when the state changes compared to the previously sent one.
...
Notification Type. [MEF113 R152]

**[R61]** The Seller **MUST** send WorkOrder Notifications to a Buyer who has
registered for the WorkOrder Notification Type. [MEF113 R153]

- `workOrderCreateEvent`
- `workOrderStateChangeEvent`
- `workOrderAppointmentRequiredEvent`

Figure 21 shows all entities involved in the Notification use cases.

![WorkOrder Notification Data Model](media/useCase22NotificationModel.png)

**Figure 21. Use Case 22. WorkOrder Notification Data Model**
...
Table 12 presents the mapping between the API Notification types' names and the
ones in MEF 113. The inconsistencies are caused by using the TMF event types as
the base for this API.
...
to be use directly only via specialization which defines a code
...
Figure 23 presents the whole Appointment Management data model the data types,
requirements related to them and mapping to MEF 113 specifications are discussed
later in this section.

![Appointment Management Data Model](media/appointmentManagement.api.png)
**Figure 23. Appointment Management Data Model**

#### 7.2.1.1. Type Appointment

**Description:** In the context of MEF 113 document, denotes an arrangement
between the Buyer and Seller for a Seller Technician to meet with the Buyer at a
specified time and place.

<table id="T_Appointment" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
    ...
    <tbody>
        ...
        <td>attachment</td>
            ...
            <td>O</td>
            <td>Attachments to the Appointment, such as a file, screenshot or embedded content.</td>
        ...
        <td>status</td>
            <td><a href="#T_AppointmentStatusType">Appointment-</br>StatusType</a></td>
            <td>M</td>
...
Seller Appointment Contact (role&#x3D;sellerAppointmentContact) - The Seller contact(s) assigned to and responsible for the Appointment.</td>
            <td>Buyer Appointment Contacts, Seller Appointment Contact</td>
        </tr><tr>
        <td>workOrder</td>
...
<table id="T_Appointment_Create" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>relatedContact-</br>Information</td>
            ...
            <td>M</td>
            <td>Party playing a role in this Appointment. The &#x27;role&#x27; is to specify the type of contact as specified in MEF 113:
Appointment Place Contact (role&#x3D;appointmentPlaceContact) - The site contact(s) that the Seller Technician may need to contact in order to get access to the Appointment Place during the Appointment. This could be an end-user, security personnel or any authorized person Buyer Appointment Contact (role&#x3D;buyerAppointmentContact)- The Buyer contact(s) assigned to and responsible for the Appointment. Seller Appointment Contact (role&#x3D;sellerAppointmentContact) - The Seller contact(s) assigned to and responsible for the Appointment.</td>
            <td>Buyer Appointment Contacts</td>
        </tr><tr>
        <td>validFor</td>
            <td><a href="#T_TimePeriod">TimePeriod</a></td>
            <td>M</td>
...
<table id="T_Appointment_Find" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>relatedPlace</td>
            <td><a href="#T_RelatedPlaceRefOrQuery">RelatedPlace-</br>RefOrQuery</a></td>
            <td>M</td>
            <td>Related place defines (by reference or value) the place where the appointment will take place.</td>
            <td>Appointment Place</td>
        </tr><tr>
        <td>status</td>
            <td><a href="#T_AppointmentStatusType">Appointment-</br>StatusType</a></td>
...
<table id="T_Appointment_Update" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
<table id="T_SearchTimeSlot" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>availableTimeSlot</td>
            ...
            <td>M</td>
            <td>A set of time slots with the availability of a Seller Technician returned by the Seller, which the Buyer may select for creating or rescheduling an Appointment.</td>
            <td>Available Timeslots</td>
        </tr><tr>
        <td>requestedTimeSlot</td>
            <td><a href="#T_TimeSlot">TimeSlot</a>[]</td>
            <td>M</td>
            <td>A set of preferred time slots the Buyer is requesting the Seller to verify for availability by a Sellers Technician at the Place referenced in the Appointment Related Entity. For example Monday thru Friday, or a set of specific time slots.</td>
...
<table id="T_SearchTimeSlot_Create" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
<table id="T_WorkOrderRef" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
Figure 24 presents the whole WorkOrder Management data model the data types,
requirements related to them and mapping to MEF 113 specifications are discussed
later in this section.

![WorkOrder Management Data Model](media/WorkOrderManagement.api.png)

**Figure 24. WorkOrder Management Data Model**
...
<table id="T_WorkOrder" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>duration</td>
            ...
            <td>M</td>
            <td>The current state of the WorkOrder</td>
        ...
        <td>relatedContact-</br>Information</td>
            ...
            <td>Workorder Contact, Technician</td>
        </tr><tr>
        <td>relatedEntity</td>
        ...
        <td>state</td>
            <td><a href="#T_WorkOrderStateType">WorkOrder-</br>StateType</a></td>
            <td>M</td>
            <td>The current state of the WorkOrder</td>
            <td>WorkOrder State</td>
        </tr><tr>
        <td>task</td>
            <td>string[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
<table id="T_WorkOrder_Find" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
<table id="T_AppointmentRef" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
#### 7.2.3.3. `enum` MEFBuyerSellerType
...
#### 7.2.3.6. Type RelatedContactInformation
...
<table id="T_TimeDuration" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
#### 7.2.3.9. `enum` TimeDurationUnits
...
#### 7.2.3.11. Type TimeSlot

**Description:**

<table id="T_TimeSlot" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>validFor</td>
            <td><a href="#T_TimePeriod">TimePeriod</a></td>
            <td>M</td>
            <td>Start date and end date of the timeSlot</td>
...
<table id="T_RelatedPlaceRefOrQuery" style="width:100%">
    ...
    <tbody>
        ...
        <td>contact</td>
            ...
            <td>Appointment Contact Information</td>
        </tr>
    </tbody>
</table>
...
#### 7.2.4.3. Type ContactInformation
...
#### 7.2.4.4. Type GeographicAddress_Query
...
#### 7.2.4.5. Type FieldedAddressRepresentation
...
#### 7.2.4.6. Type FormattedAddressRepresentation
...
#### 7.2.4.7. Type GeographicPointRepresentation
...
#### 7.2.4.8. Type LabelRepresentation
...
#### 7.2.5.2. EventSubscriptionInput
...
Figure 25 presents the whole WorkOrder Management data model the data types,
requirements related to them and mapping to MEF 113 specifications are discussed
later in this section.

![Appointment Notification Data Model](media/appointmentNotification.api.png)

**Figure 25. Appointment Notification Data Model**

#### 7.3.2.1. Type AppointmentAttributeValueChangeEvent
...
<table id="T_AppointmentAttributeValueChangeEvent" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>eventType</td>
            ...
            <td>Appointment Notification Type</td>
        </tr><tr>
        <td>event</td>
            <td><a href="#T_AppointmentAttributeValueChangeEventPayload">AppointmentAttributeValueChangeEventPayload</a></td>
            <td>M</td>
...
#### 7.3.2.2. Type AppointmentAttributeValueChangeEventPayload

**Description:** The identifier of the Appointment is subject of this event.

<table id="T_AppointmentAttributeValueChangeEventPayload" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
#### 7.3.2.3. Type AppointmentStatusChangeEvent
...
<table id="T_AppointmentStatusChangeEvent" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_AppointmentStatusChangeEventPayload">AppointmentStatusChangeEventPayload</a></td>
            <td>M</td>
            <td>A reference to the object that is the source of the notification.
</td>
            <td>Appointment Identifier</td>
...
#### 7.3.2.4. Type AppointmentStatusChangeEventPayload

**Description:** The identifier of the Product Offering being subject of this
event.

<table id="T_AppointmentStatusChangeEventPayload" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
Figure 26 presents the whole WorkOrder Management data model the data types,
requirements related to them and mapping to MEF 113 specifications are discussed
later in this section.

![WorkOrder Notification Data Model](media/workorderNotification.api.png)
**Figure 26. WorkOrder Notification Data Model**

#### 7.3.2.1. Type WorkOrderAppointmentRequiredEvent
...
<table id="T_WorkOrderAppointmentRequiredEvent" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>eventType</td>
            ...
            <td>M</td>
            <td>Indicates the type of the event.</td>
            <td>Workorder Notification Type</td>
        </tr><tr>
        <td>event</td>
...
#### 7.3.2.2. Type WorkOrderCreateEvent
...
<table id="T_WorkOrderCreateEvent" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
#### 7.3.2.3. Type WorkOrderEventPayload

**Description:** The identifier of the WorkOrder is subject of this event.

<table id="T_WorkOrderEventPayload" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
#### 7.3.2.4. Type WorkOrderStateChangeEvent
...
<table id="T_WorkOrderStateChangeEvent" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_WorkOrderStateChangeEventPayload">WorkOrderStateChangeEventPayload</a></td>
            <td>M</td>
            <td>A reference to the object that is the source of the notification.
</td>
            <td>Workorder Identifier</td>
...
#### 7.3.2.5. Type WorkOrderStateChangeEventPayload

**Description:** The identifier of the Product Offering being subject of this
event.

<table id="T_WorkOrderStateChangeEventPayload" style="width:100%">
    <thead style="font-weight:bold">
        <tr>
            <td>Name</td>
            <td style="width:15%">Type</td>
...
- [Mplify 121.1](https://www.mplify.net/wp-content/uploads/Mplify-121.1.pdf),
  ...
  2025
- [Mplify 124.1](https://www.mef.net/wp-content/uploads/MEF-124.1.pdf), LSO
  Cantata and LSO Sonata Trouble Ticket and Incident Management API - Developer
  Guide, November 2025
...
- [TMF646](https://www.tmforum.org/resources/standard/tmf646-appointment-management-api-rest-specification-r19-0-0/),
  TMF646 Appointment Management API REST Specification R19.0.1
- [TMF697](https://github.com/tmforum-apis/TMF697_Work_Order/blob/main/TMF697-WorkOrder-v4.0.0.swagger.json),
