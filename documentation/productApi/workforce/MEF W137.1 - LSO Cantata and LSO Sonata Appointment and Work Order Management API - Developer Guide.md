...
- [7. API Details](#7-api-details)
  ...
  - [7.2. Management API Data model](#72-management-api-data-model)
    ...
    - [7.2.4. Notification registration](#724-notification-registration)
      - [7.2.4.1. EventSubscription](#7241-eventsubscription)
      - [7.2.4.2. EventSubscriptionInput](#7242-eventsubscriptioninput)
  - [7.3. Notification API Data Model](#73-notification-api-data-model)
    ...
    - [7.3.2. Appointment Notification.](#732-appointment-notification)
      ...
      - [7.3.2.2. Type AppointmentStatusChangeEventPayload](#7322-type-appointmentstatuschangeeventpayload)
    - [7.3.3. WorkOrder Notification.](#733-workorder-notification)
      ...
      - [7.3.2.3. Type WorkOrderCreateEvent](#7323-type-workordercreateevent)
      - [7.3.2.3. Type WorkOrderEventPayload](#7323-type-workordereventpayload)
      - [7.3.2.2. Type WorkOrderStateChangeEvent](#7322-type-workorderstatechangeevent)
      - [7.3.2.3. Type WorkOrderStateChangeEventPayload](#7323-type-workorderstatechangeeventpayload)
...
- [`productApi/workforce/appointment/appointmentManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/workforce/appointment/appointmentManagement.api.yaml)
- [`productApi/workforce/appointment/appointmentNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/workforce/appointment/appointmentNotification.api.yaml)
- [`productApi/workforce/appointment/workorderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/workforce/appointment/workorderManagement.api.yaml)
- [`productApi/workforce/appointment/workorderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/workforce/appointment/workorderNotification.api.yaml)
...
- [`productApi/workforce/appointment/appointmentManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/workforce/appointment/appointmentManagement.api.yaml)
- [`productApi/workforce/appointment/appointmentNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/workforce/appointment/appointmentNotification.api.yaml)
- [`productApi/workforce/appointment/workorderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/workforce/appointment/workorderManagement.api.yaml)
- [`productApi/workforce/appointment/workorderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/workforce/appointment/workorderNotification.api.yaml)
...
[[MEF 113](#8-references)]. MEF W113 defines use cases that cover Trouble
...
Incident use cases are covered by [MEF 124](#8-references) LSO Cantata and LSO
...
Trouble Ticket Management API - Developer Guide_ [[MEF 124](#8-references)],
...
When required the place information can be provided with the `RelatedPlaceRefOrQuery` type, which is
...
One or more of these representations can be used to describe a single
place. 
...
**[R9]** The Buyer's request **MUST** include the following attributes:
[MEF113 R71]
...
flow example with the use of Notifications is presented in Figure 11.
...
**[R13]** The Buyer's request **MUST** include the following attributes:
[MEF113 R78]
...
**[R16]** The Seller's response **MUST** include the Buyer following
...
**[R21]** The Seller **MUST** set the `appointmentRequired` attribute to
...
**[R26]** The Seller **MUST** send an `AppointmentStatusChangeEvent` whenever
...
**[R35]** The Buyer **MUST NOT** change any of the following attributes:
[MEF113 R102]
...
**[R39]** If `validfor` was included by the Buyer, the Seller **MUST** return
...
Table 11 presents the mapping between the API Notification types' names
...
Table 12 presents the mapping between the API Notification types' names
and the ones in MEF 113. The inconsistencies are caused by using the TMF event
types as the base for this API.
...
<table id="T_WorkOrderStateType">
    ...
    <tbody>
        <tr>
            ...
            <td>unableToComplete</td>
            <td>UNABLE_TO_COMPLETE</td>
        </tr>
    </tbody>
</table>
...
**Description:** Extra information about a given entity. Only useful in processes involving human interaction. Not applicable to an automated process.
...
#### 7.2.4.2. EventSubscriptionInput
...
<table id="T_EventSubscriptionInput">
    ...
    <tbody>
        <tr>
            <td>callback*</td>
            <td>string</td>
            <td>This callback value must be set to *host* property from Buyer Notification API (appointmentNotification.api.yaml). This property is appended with the base path and notification resource path specified in that API to construct an URL to which notification is sent. E.g. for &quot;callback&quot;: &quot;http://buyer.mef.com/listenerEndpoint&quot;, the status change event notification will be sent to: &#x60;http://buyer.mef.com/listenerEndpoint/mefApi/sonata/appointmentNotification/v2/listener/appointmentStatusChangeEvent&#x60;</td>
            <td>Notification Target Information</td>
        </tr><tr>
            <td>query</td>
            <td>string</td>
...
#### 7.3.2.2. Type AppointmentStatusChangeEventPayload
...
#### 7.3.2.3. Type WorkOrderCreateEvent
...
#### 7.3.2.2. Type WorkOrderStateChangeEvent
...
#### 7.3.2.3. Type WorkOrderStateChangeEventPayload
...
- [MEF 113](https://www.mef.net/wp-content/uploads/MEF-113.pdf),
