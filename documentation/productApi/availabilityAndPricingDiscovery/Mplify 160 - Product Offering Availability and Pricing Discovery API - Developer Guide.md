...
cases are defined in Mplify 110 _Product Offering Availability and Pricing
Discovery - Business Requirements and Use Cases_ [[Mplify 110](#8-references)].
...
As specified in [[Mplify 110](#8-references)]:
...
Discovery functionality are defined in Mplify 110 [[Mplify110](#8-references)].
...
Figure 4 presents a high-level use case diagram as specified in Mplify 110
[[Mplify110](#8-references)]. This picture aims to help understand endpoint
...
| API endpoint                        | Description                                                                                                                            | Mplify 110 Use case mapping                  |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
...
are listed in Table 2. [Mplify110 R1], [Mplify110 R2], [Mplify110 R24],
[Mplify110 R25]
...
such a case the schema identifier must be agreed upon between the Buyer and the
Seller.
...
MEFProductConfiguration:
  description:
    MEFProductConfiguration is used as an extension point for Mplify-specific
...
section 8 of [[Mplify110](#8-references)].
...
For more details please refer to [[Mplify 110](#8-references)], section 9.1.
...
- `productSpecification`: to point to product specification that is of Buyer's
  ...
  defined by Mplify standard describing the Access E-Line. In practice, this is
  an identifier as presented by the Seller in the Product Catalog.
...
`place` attribute. [Mplify110 R5], [Mplify110 R9]

**[R13]** When specifying the `place`, the Buyer **MUST** provide following
attributes: [Mplify110 R48]
...
in the `productRelationship` attribute. [Mplify110 R6], [Mplify110 R8]
...
**[R16]** If `action=modify`, the request **MUST** provide `productRef`.
[Mplify110 R4]

**[R17]** If `action=modify`, the request **MUST NOT** provide following
attributes: [Mplify110 R10]
...
Offering Availability request. [Mplify110 R12]
...
which all other attributes are the same). [Mplify110 R13]
...
**MUST** return an `Error` response with the appropriate Error Code. [Mplify110
R15], [Mplify110 R16]

**[R22]** For each returned `ProductOfferingConfiguration` the Seller **MUST**
include following attributes: [Mplify110 R17], [Mplify110 R18], [Mplify110 R21],
[Mplify110 R20]
...
uniquely identify a `ProductOfferingConfiguration` within the Seller. [Mplify110
R17]
...
the onboarding. [Mplify110 R19], [Mplify110 R20]
...
**[R26]** The request **MUST** provide: [Mplify110 R26], [Mplify110 R28]
...
attribute. [Mplify110 R26], [Mplify110 R30]
...
`productRelationship` attribute. [Mplify110 R26], [Mplify110 R31]

**[R29]** If `action=add`, the request **MUST NOT** provide `productRef`.
[Mplify110 R27]

**[R30]** If `action=modify`, the request **MUST** additionaly provide
`productRef`. [Mplify110 R28]

**[R31]** If `action=modify`, the request **MUST NOT** provide: [Mplify110 R29]
...
provide the `term.rollInterval` attribute. [Mplify110 R40]
...
<table id="T_ProductOfferingRef" style="width:100%">
    ...
    <tbody>
        ...
        <td>href</td>
            ...
            <td>Not represented in Mplify 110</td>
        </tr><tr>
        <td>id</td>
            <td>string</td>
            <td>M</td>
...
Mplify specific product/service payload. The `@type` attribute is used as a
discriminator
...
<table id="T_QuotePrice" style="width:100%">
    ...
    <tbody>
        ...
        <td>unitOfMeasure</td>
            <td>string</td>
            <td>O</td>
            <td>Unit of Measure if price depending on it (Gb, SMS volume, etc..) Mplify: if Quote Item Price Type equals usageBased</td>
...
The following mapping has been used between `ProductActionType` and Mplify 110:

| ProductActionType | Mplify 110 |
| ----------------- | ---------- |
| add               | INSTALL    |
| modify            | CHANGE     |
...
- [MEF 55.1](https://www.mplify.net/wp-content/uploads/2021/02/MEF-55.1.pdf),
  Lifecycle Service Orchestration (LSO): Reference Architecture and Framework,
  February 2021
- [MEF 55.1.1](https://www.mplify.net/wp-content/uploads/MEF-55.1.1.pdf),
  Amendment to MEF 55.1: Reference Architecture and Framework - Terminology,
  June 2023
- [MEF 80](https://www.mplify.net/wp-content/uploads/MEF-80.pdf), Quote
  Management Requirements and Use Cases, July 2021
- [MEF 87](https://www.mplify.net/wp-content/uploads/MEF-87.pdf), LSO Cantata
  and LSO Sonata Product Offering Qualification API - Developer Guide, May 2022
- [MEF 106](https://www.mplify.net/wp-content/uploads/MEF-106.pdf), LSO Sonata
  Access E-Line Product Schemas and Developer Guide, February 2023
- [Mplify 110](https://www.mplify.net/wp-content/uploads/Mplify-110.pdf),
  Product Offering Availability and Pricing Discovery - Business Requirements
  and Use Cases, January 2025
- [MEF 115](https://www.mplify.net/wp-content/uploads/MEF-115.pdf), LSO Cantata
  and LSO Sonata Quote Management API - Developer Guide, May 2022
- [MEF 128.1](https://www.mplify.net/wp-content/uploads/MEF-128.1.pdf), LSO API
