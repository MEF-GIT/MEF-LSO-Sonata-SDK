...
defined in MEF 79.1 _Product Offering Qualification Management Business
Requirements and Use Cases_ [[MEF79.1](#8-references)].
...
- [`productApi/serviceability/offeringQualification/productOfferingQualificationManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/serviceability/offeringQualification/productOfferingQualificationManagement.api.yaml)
- [`productApi/serviceability/offeringQualification/productOfferingQualificationNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/serviceability/offeringQualification/productOfferingQualificationNotification.api.yaml)
...
- [`productApi/serviceability/offeringQualification/productOfferingQualificationManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/serviceability/offeringQualification/productOfferingQualificationManagement.api.yaml)
- [`productApi/serviceability/offeringQualification/productOfferingQualificationNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/serviceability/offeringQualification/productOfferingQualificationNotification.api.yaml)
...
<table>
  ...
  <tr>
    ...
    <td><a href="#8-references">[MEF79.1]</a> </td>
  </tr>
  <tr>
    <td>POQ Item</td>
...
<table>
  ...
  <tr>
    ...
    <td><a href="#8-references">[MEF79.1]</td>
  </tr>
  <tr>
    <td>Buyer</td>
...
The requirements and use cases for POQ functionality are defined in MEF 79.1
[[MEF79.1](#8-references)]. Product specifications are defined using JSON Schema
(draft 7) standard [[JS](#8-references)], whereas POQ API is defined using
OpenAPI 3.0 standard [[OAS-V3](#8-references)]. The product payloads exchanged
through POQ endpoints must comply with respective product specifications. This
standard is based on TMF 679 API as specified by _TMF679 Product Offering
Qualification API REST Specification_ [[TMF679](#8-references)].
...
for trading MEF subscriber and MEF operator services. This standard does not
define MEF product specifications, however, can be used along with any product
specification defined by or compliant with MEF.
...
`GeographicAddress_Query`. [MEF79.1 R1]
...
| API endpoint                               | Description                                                                                                                                      | MEF 79.1 Use case Mapping                                      |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- |
...
**[R2]** A Buyer **MUST** be able to initiate Use Cases 2a, 2c, and 4. [MEF79.1
R2]

**[D1]** A Buyer **SHOULD** be able to initiate Use Case 2b. [MEF79.1 D1]
...
Deferred Response for Use Cases 2a and 2c. [MEF79.1 R3]

**[CR1]<[D1]** The Seller **MUST** be able to provide an Immediate Response or a
Deferred Response for Use Case 2b. [MEF79.1 CR1<D1]
...
Notifications (Use Case 5) when the Buyer has registered for them. [MEF79.1 R4]
...
`MEFPOQTaskStateType` and MEF 79.1.

| MEFPOQTaskStateType | MEF 79.1            | Description                                                                                                                                                                                                               |
| ------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
POQ Items that are not `done` **MUST** move to `done.abandoned`. [MEF79.1 R103]
...
`terminatedWithError` or `rejected` state. [MEF79.1 R99]
...
`MEFPOQItemTaskStateType` and MEF 79.1.

| MEFPOQItemTaskStateType | MEF 79.1            | Description                                                                                                                                                                                                                                                                                      |
| ----------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
defined in Table 8. [MEF79.1 R100]
...
Figure 11 depicts two MEF `<<ProductSpecifications>>` that represent Access
...
**MUST** provide relevant HTTP Response codes. [MEF79.1 R8], [MEF79.1 R27],
[MEF79.1 R36], [MEF79.1 R55], [MEF79.1 R64], [MEF79.1 R78], [MEF79.1 R84]
...
**[R25]** The Buyer **MUST** specify following attributes: [MEF79.1 R9],
[MEF79.1 R12]
...
attribute as `true`. [MEF79.1 R10]

**[R27]** The Buyer **MUST** specify following attributes of
`RelatedContactInformation`: [MEF79.1 R22]
...
`instantSyncQualification=false`, [MEF79.1 R11]

**[R29]** The Buyer **MUST** specify following attributes of
`productOfferingQualificationItem`: [MEF79.1 R17], [MEF79.1 R48]
...
[MEF79.1 R23], [MEF79.1 R51]

**[R31]** When specifying the `productRelationship`, the Buyer **MUST** provide
following attributes`: [MEF79.1 R25], [MEF79.1 R53]
...
[MEF79.1 R24], [MEF79.1 R52]

**[R33]** When specifying the `qualificationItemRelationship`, the Buyer
**MUST** provide following attributes`: [MEF79.1 R26], [MEF79.1 R54]
...
**MUST** be used to detail the place relationship. [MEF79.1 R18]

**[R35]** When specifying the `product.place`, the Buyer **MUST** provide the
following attributes: [MEF79.1 R19]
...
describe exactly where the Buyer wants the Product to be installed. [MEF79.1 O4]

**[R36]** When specifying the `ContactInformation`, the Buyer **MUST** provide
following attributes`: [MEF79.1 R22]
...
`poqItem.product`: [MEF79.1 R48], [MEF79.1 R50]
...
`product.productOffering` than the one of the existing Product. [MEF79.1 O10]

**[R41]** If `product.productOffering` changes, it **MUST** be based on the same
`product.productSpecification` as the existing Product. [MEF79.1 R49]
...
request (not changed). [MEF79.1 R34], [MEF79.1 R37], [MEF79.1 R62], [MEF79.1
R64]
...
following attributes of `ProductOfferingQualification`: [MEF79.1 R29], [MEF79.1
R33], [MEF79.1 R38], [MEF79.1 R56], [MEF79.1 R60], [MEF79.1 R61], [MEF79.1 R66]
...
Seller's system. [MEF79.1 R32], [MEF79.1 R59]

**[R46]** Each item in the `productOfferingQualificationItem` list in the
response **MUST** correspond to an item from a list in the request. [MEF79.1
R27], [MEF79.1 R42], [MEF79.1 R70]

**[R47]** The Seller response to a Use Case 2a request **MUST** match the
Product Offering specified in the request. [MEF79.1 R15]

**[R48]** The Seller response to a Use Case 2b request **MUST** match the
Product Specification provided in the request. [MEF79.1 R13], [MEF79.1 R16]
...
`ProductOfferingQualificationItem`: [MEF79.1 R43], [MEF79.1 R72]

- `serviceabilityConfidence`

**[R52]** The Seller **MUST** provide following attributes' values: [MEF79.1
R38], [MEF79.1 R39], [MEF79.1 R40], [MEF79.1 R66], [MEF79.1 R67], [MEF79.1 R68],
[MEF79.1 R71]
...
`yellow` the Seller **MUST** provide the following attributes' values: [MEF79.1
R44], [MEF79.1 R73], [MEF79.1 R74]
...
the Product Offering. [MEF79.1 O2]
...
requested by the Buyer. [MEF79.1 O3], [MEF79.1 O9], [MEF79.1 O14]

**[R54]** When specifying the `alternateProductOfferingProposal`, the Seller
**MUST** provide following attributes`: [MEF79.1 R45], [MEF79.1 R46], [MEF79.1
R75], [MEF79.1 R76]
...
for the Product Offering Qualification list. [MEF79.1 O15]
...
**[CR1]<[D4]** Seller **MUST** use either `X-Total-Count` or
...
`ProductOfferingQualification_Find` objects in the response. [MEF79.1 R80]

**[R57]** For each `ProductOfferingQualification_Find` returned, the Seller
**MUST** specify values (if present) of the following attributes: [MEF79.1 R81]
...
`ProductOfferingQualification` in the query. [MEF79.1 R82]
...
**[R60]** The Seller **MUST** provide the following attributes: [MEF79.1 R85]
...
`ProductOfferingQualificationItem`: [MEF79.1 R87], [MEF79.1 R89]
...
of `ProductOfferingQualificationItem`: [MEF79.1 R83]
...
`yellow` the Seller **MUST** provide values for `installationInterval` and
`deliveryType` attributes: [MEF79.1 R83]

**[D5]** If `state=done` the Seller **SHOULD** specify the
`guaranteedUntilDate`. [MEF79.1 D7]

**[R66]** If `state=rejected` the Seller **MUST** only provide (aside from buyer
set) the following attributes of `ProductOfferingQualificationItem`: [MEF79.1
R90]
...
generate notifications to the Buyer. [MEF79.1 R5]

**[R73]** If the Buyer has not registered for notifications, the Seller **MUST
NOT** generate notifications to the Buyer. [MEF79.1 R6]

**[R74]** Seller **MUST** send events only to Buyers who have registered to
receive such notifications. [MEF79.1 R91].

**[R75]** The state change notifications **MUST** be sent only in the Deferred
Response scenario. [MEF79.1 R92]

There are no state changes in the Immediate scenario.

**[R76]** The Seller **MUST** send a notification to all of the targets
specified by the Buyer in their Register for POQ Notifications request. [MEF79.1
R92]

R44 means, that the Buyer may have multiple subscriptions listeners registered
...
`PoqStateChangeEventPayload` when sending `PoqStateChangeEvent`: [MEF79.1 R93]
...
data types, requirements related to them, and mapping to MEF 79.1 specifications
...
<table id="T_ProductOfferingQualification_Create" style="width:100%">
    ...
    <tbody>
        ...
        <td>productOfferingQualificationItem</td>
            <td><a href="#T_ProductOfferingQualificationItem_Create">ProductOfferingQualificationItem_Create</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
<table id="T_ProductOfferingQualification" style="width:100%">
    ...
    <tbody>
        ...
        <td>productOfferingQualificationItem</td>
            <td><a href="#T_ProductOfferingQualificationItem">ProductOfferingQualificationItem</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
The following mapping has been used between `MEFPOQTaskStateType` and MEF 79.1:
...
The following mapping has been used between `PoqProductActionType` and MEF 79.1:

| PoqProductActionType | MEF 79.1 |
| -------------------- | -------- |
| add                  | INSTALL  |
| modify               | CHANGE   |
...
**MUST NOT** be specified if &#x27;state&#x27; is &#x27;terminatedWithError&#x27; or &#x27;done.abandoned&#x27;.
        ...
        <td>3rdPartyProviderProductOffering</td>
            <td>string</td>
            <td>O</td>
...
| red                 | The Seller cannot deliver the Product Offering as specified. The Seller may or may not have alternate Product Offerings that could be substituted.                                                                                                                                                                                                                                                                                                                                   |
...
| onNetWithoutBuild  | A place that has an existing connection to the Seller's network. This may require augmentation of additional equipment.                                                                                                                                        |
...
<table id="T_AlternateProductOfferingProposal" style="width:100%">
    ...
    <tbody>
        ...
        <td>serviceabilityConfidence</td>
            <td><a href="#T_AlternateServiceabilityColor">AlternateServiceabilityColor</a></td>
            <td>M</td>
...
the Buyer. If 1) the Buyer has set `provideAlternate=true`; 2) the Seller has
determined that the POQ Confidence Level for this item is `yellow` or `red`;
and 3) The Seller has alternate Products (e.g. similar but lower bandwidth) that
may be adequate.
...
<table id="T_MEFAlternateProduct" style="width:100%">
    ...
    <tbody>
        ...
        <td>productConfiguration</td>
            <td><a href="#T_MEFProductConfiguration">MEFProductConfiguration</a></td>
            <td>M</td>
            <td>MEFProductConfiguration is used to get MEF specific product/service payload. the @type is used a a discriminator.</td>
            <td>Product Specific Attributes</td>
        </tr>
    </tbody>
</table>
...
<table id="T_EventSubscriptionInput" style="width:100%">
    ...
    <tbody>
        ...
        <td>query</td>
            <td>string</td>
            <td>O</td>
            <td>This attribute is used to define to which type of events to register to. Example: &quot;query&quot;:&quot;eventType &#x3D; poqStateChangeEvent&quot;. To subscribe for more than one event type, put the values separated by comma: &#x60;eventType&#x3D;poqStateChangeEvent,poqItemStateChangeEvent&#x60;. The possible values are enumerated by the &#x27;POQEventType&#x27; in productOfferingQualificationNotification.api.yaml. An empty query is treated as specifying no filters - ending in  subscription for all event types.</td>
            <td>List of Notification Types</td>
        </tr><tr>
        <td>callback</td>
            <td>string</td>
            <td>M</td>
            <td>This callback value must be set to *host* property from Buyer ProductOfferingQualification Notification API (productOfferingQualificationNotification.api.yaml). This property is appended with the base path and notification resource path specified in that API to construct an URL to which notification is sent. E.g. for &quot;callback&quot;: &quot;https://buyer.mef.com/listenerEndpoint&quot;, the create event notification will be sent to: &#x60;https://buyer.mef.com/listenerEndpoint/mefApi/sonata/productOfferingQualificationNotification/v8/listener/poqStateChangeEvent&#x60;</td>
...
Figure 19 presents the model of Notification API.

![Notifications](media/notifications.png)

**Figure 19. Notification API**
...
<table id="T_PoqStateChangeEvent" style="width:100%">
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_PoqStateChangeEventPayload">PoqStateChangeEventPayload</a></td>
            <td>M</td>
...
<table id="T_PoqItemStateChangeEvent" style="width:100%">
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_PoqItemStateChangeEventPayload">PoqItemStateChangeEventPayload</a></td>
            <td>M</td>
            <td>A reference to the POQ that is source of the notification.
</td>
            <td></td>
