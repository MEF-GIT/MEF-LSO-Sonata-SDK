...
<table id="T_ProductOfferingQualification" style="width:100%">
    ...
    <tbody>
        ...
        <td>stateChange</td>
            <td><a href="#T_MEFPOQStateChange">MEFPOQStateChange</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
<table id="T_ProductOfferingQualificationItem" style="width:100%">
    ...
    <tbody>
        ...
        <td>stateChange</td>
            <td><a href="#T_MEFPOQItemStateChange">MEFPOQItemStateChange</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
