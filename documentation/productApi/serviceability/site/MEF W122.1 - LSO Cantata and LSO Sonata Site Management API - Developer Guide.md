...
- [`productApi/serviceability/site/geographicSiteManagement.api.yaml`](https://github.com/MEF-GIT/MEF-LSO-Sonata-SDK-extended/raw/develop_site/productApi/serviceability/site/geographicSiteManagement.api.yaml)

<https://github.com/MEF-GIT/MEF-LSO-Cantata-SDK>

- [`productApi/serviceability/site/geographicSiteManagement.api.yaml`](https://github.com/MEF-GIT/MEF-LSO-Cantata-SDK-extended/raw/develop_site/productApi/serviceability/site/geographicSiteManagement.api.yaml)
...
and Use Cases_ [[MEF150](#8-references)] which introduced the _Installation
...
`GeographicAddress`, according to the before-mentioned MEF Standard.
...
<!-- TODO check bulletlist and figure formatting after PDF gen -->
...
with [MEF 150](#8-references). The underlined font designates required use
cases.
...
| API endpoint               | Description                                                                                                                                                     | MEF 150 Use case Mapping                  |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
...
to perform Use Case 4. [MEF150 R21]
...
<!-- TODO Review - do we want to make the figute more accurate? -->
...
Table 4 keeps the original use case numbering and naming from MEF 150. The
...
**[O1]** The Buyer **MAY** use any of the following attributes: [MEF150 O7],
[MEF150 O9]
...
`Error422` with `tooManyRecords` code. [MEF150 O8], [MEF150 O10]

**[R6]** The Buyer **MUST** specify the `place` as search criteria. [MEF150
R43], [MEF150 R44]
...
the `place` attribute of the request. [MEF150 R45]
...
following attributes: [MEF150 R48]
...
within the Seller's network. [MEF150 R50], [MEF150 R52]
...
<!-- TODO review all examples for the new required model -->
...
**[R17]** When providing the response, the Seller **MUST** specify: [MEF150 R54]
...
- [MEF 150](https://www.mef.net/resources/mef-150-installation-place-and-service-site-management-business-requirements-and-use-cases/),
