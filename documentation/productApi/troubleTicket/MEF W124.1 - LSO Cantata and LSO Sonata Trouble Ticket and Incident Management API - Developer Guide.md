...
- [7. API Details](#7-api-details)
  ...
  - [7.3. Notification API Data model](#73-notification-api-data-model)
    ...
    - [7.3.8. `enum` TroubleTicketStatusType](#738-enum-troubleticketstatustype)
    - [7.3.9. Type IncidentAttributeValueChangeEvent](#739-type-incidentattributevaluechangeevent)
    - [7.3.10. Type IncidentCreateEvent](#7310-type-incidentcreateevent)
    - [7.3.11. Type IncidentEventPayload](#7311-type-incidenteventpayload)
    - [7.3.12. Type IncidentStatusChangeEvent](#7312-type-incidentstatuschangeevent)
    - [7.3.13. Type IncidentStatusChangeEventPayload](#7313-type-incidentstatuschangeeventpayload)
    - [7.3.14. `enum` IncidentStatusType](#7314-enum-incidentstatustype)
...
- [`productApi/troubleTicket/troubleTicketManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/troubleTicket/troubleTicketManagement.api.yaml)
- [`productApi/troubleTicket/troubleTicketNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/troubleTicket/troubleTicketNotification.api.yaml)
...
- [`productApi/troubleTicket/troubleTicketManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/troubleTicket/troubleTicketManagement.api.yaml)
- [`productApi/troubleTicket/troubleTicketNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/troubleTicket/troubleTicketNotification.api.yaml)
...
W113 _Trouble Ticketing Requirements and Use Cases_ [[MEF 113](#8-references)].
MEF W113 defines use cases that cover Trouble Ticket, Incident, Appointment, and
...
potential types in MEF (e.g. `Service`). In this version, the only type that is
mentioned in the implemented requirements document is the `Product` and to ease
the request `RelatedEntity.@ReferredType` and the `relatedEntityType` in the
filter criteria has a default value: `Product`.
...
### 7.3.8. `enum` TroubleTicketStatusType
...
### 7.3.9. Type IncidentAttributeValueChangeEvent
...
### 7.3.10. Type IncidentCreateEvent
...
### 7.3.11. Type IncidentEventPayload
...
### 7.3.12. Type IncidentStatusChangeEvent
...
### 7.3.13. Type IncidentStatusChangeEventPayload
...
### 7.3.14. `enum` IncidentStatusType
