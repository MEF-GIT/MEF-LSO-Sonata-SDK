...
- [7. API Details](#7-api-details)
  ...
  - [7.3. Notification API Data model](#73-notification-api-data-model)
    ...
    - [7.3.10. `enum` MEFProductOrderStateType](#7310-enum-mefproductorderstatetype)
    - [7.3.11. `enum` MEFProductOrderItemStateType](#7311-enum-mefproductorderitemstatetype)
    - [7.3.12. Type CancelProductOrderStateChangeEvent](#7312-type-cancelproductorderstatechangeevent)
    - [7.3.13. Type CancelProductOrderStateChangeEventPayload](#7313-type-cancelproductorderstatechangeeventpayload)
    - [7.3.14. Type ModifyProductOrderItemRequestedDeliveryDateStateChangeEvent](#7314-type-modifyproductorderitemrequesteddeliverydatestatechangeevent)
    - [7.3.15. Type ModifyProductOrderItemRequestedDeliveryDateStateChangeEventPayload](#7315-type-modifyproductorderitemrequesteddeliverydatestatechangeeventpayload)
    - [7.3.16. `enum` MEFChargeableTaskStateType](#7316-enum-mefchargeabletaskstatetype)
    - [7.3.17. Type ChargeCreateEvent](#7317-type-chargecreateevent)
    - [7.3.18. Type ChargeTimeoutEvent](#7318-type-chargetimeoutevent)
    - [7.3.19. Type ChargeEventPayload](#7319-type-chargeeventpayload)
    - [7.3.20. Type ChargeStateChangeEvent](#7320-type-chargestatechangeevent)
    - [7.3.21. Type ChargeStateChangeEventPayload](#7321-type-chargestatechangeeventpayload)
    - [7.3.22. `enum` MEFProductOrderChargeStateType](#7322-enum-mefproductorderchargestatetype)
...
[[MEF 57.2](#8-references)] and it's _Amendment_ [[MEF 57.2.1](#8-references)].
This standard consists of this document and complementary API definitions for
Product Order Management and Product Order Notification.
...
- [`productApi/order/productOrderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/order/productOrderManagement.api.yaml)
- [`productApi/order/productOrderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Sonata-SDK/refs/tags/irene/productApi/order/productOrderNotification.api.yaml)
...
- [`productApi/order/productOrderManagement.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/order/productOrderManagement.api.yaml)
- [`productApi/order/productOrderNotification.api.yaml`](https://raw.githubusercontent.com/MEF-GIT/MEF-LSO-Cantata-SDK/refs/tags/irene/productApi/order/productOrderNotification.api.yaml)
...
- <a href="#8-references">MEF MEF 57.2</a>
- <a href="#8-references">MEF 79.1</a>
...
<tr>
  ...
  <td><a href="#8-references">[MEF 150]</a></td>
</tr>
<tr>
...
[[MEF 57.2.1](#8-references)]. Product specifications are defined using JSON
...
| `POST /listener/productOrderItemExpectedCompletionDateSetEvent` | A request initiated by the Seller to notify the Buyer on the `productOrder.productOrderItem.expectedCompletionDate` value set. | UC 15: Send Notification                                                                                                                                                                                                                                               |
...
| `POST /listener/cancelProductOrderStateChangeEvent`             | A request initiated by the Seller to notify the Buyer of the `CancelProductOrder` state change.                                | UC 15: Send Notification                                                                                                                                                                                                                                               |
...
Product Order API with a number of MEF product specifications, from both
...
properties to the Product Order payload. The extension mechanism is described in
detail in [Section 5.4](#54-integration-of-product-specific-attributes).
...
**[R12]** The Buyer's Create Product Order request **MUST** contain: [MEF57.2
R22], [MEF57.2 R16]
...
- `relatedContactInformation` items with the following values of `role` set
  (only when `action` is `add` or `modify`):
...
**[R58]** The Buyer **MUST** add a `note` only with `source=note`. [MEF57.2
R11], [MEF57.2 R12]
...
**[R111]** An event triggered by the Product Order Item
(`productOrderItemStateChangeEvent`,
`productOrderItemExpectedCompletionDateSetEvent`,
`productSpecificProductOrderItemMilestoneEvent`) **MUST** additionally contain
the relative `orderItemId`. [MEF57.2 R124]

**[R112]** A `StateChange` type of event (`productOrderStateChangeEvent`,
`productOrderItemStateChangeEvent`, `cancelProductOrderStateChangeEvent`,
`chargeStateChangeEvent`,
`modifyProductOrderItemRequestedDeliveryDateStateChangeEvent`) **MUST**
additionally contain the `state` attribute.
...
**_Note_**: the body of the event carries only the source object's `id` and
`state` (where applicable). The Buyer needs to query it later by `id` to get
details.
...
<table id="T_ProductOrder" style="width:100%">
    ...
    <tbody>
        ...
        <td>stateChange</td>
            <td><a href="#T_MEFProductOrderStateChange">MEFProductOrderStateChange</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
<table id="T_ProductOrderItem" style="width:100%">
    ...
    <tbody>
        ...
        <td>stateChange</td>
            <td><a href="#T_MEFProductOrderItemStateChange">MEFProductOrderItemStateChange</a>[]<br/><span style="font-size:10px;font-style:italic">minItems = 1</span></td>
            <td>M</td>
...
<table id="T_MEFOrderItemCoordinationDependencyType">
    <thead style="font-weight:bold;">
        <tr>
            <td>Value</td>
            <td>MEF 57.2</td>
    ...
    <tbody>
        <tr>
            ...
            <td>startToFinish</td>
            <td>START_TO_FINISH</td>
        </tr><tr>
            <td>finishToStart</td>
            <td>FINISH_TO_START</td>
        </tr><tr>
            <td>finishToFinish</td>
            <td>FINISH_TO_FINISH</td>
        </tr>
    </tbody>
</table>
...
<table id="T_ProductOrderItemExpectedCompletionDateSetEvent" style="width:100%">
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_ProductOrderItemExpectedCompletionDateSetEventPayload">ProductOrderItemExpectedCompletionDateSetEventPayload</a></td>
            <td>M</td>
...
<table id="T_ProductSpecificProductOrderItemMilestoneEvent" style="width:100%">
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_ProductSpecificProductOrderItemMilestoneEventPayload">ProductSpecificProductOrderItemMilestoneEventPayload</a></td>
            <td>M</td>
            <td>A reference to the Product Order that is source of the notification.
</td>
            <td></td>
...
<table id="T_MEFProductOrderStateType">
    <thead style="font-weight:bold;">
        <tr>
            <td>Value</td>
            <td>MEF 57.2</td>
    ...
    <tbody>
        <tr>
            ...
            <td>held.assessingCharge</td>
            <td>HELD.ASSESSING_CHARGE</td>
        </tr><tr>
            <td>inProgress</td>
            <td>IN_PROGRESS</td>
        </tr><tr>
            ...
            <td>pending.assessingModification</td>
            <td>PENDING.ASSESSING_MODIFICATION</td>
        </tr><tr>
            <td>pendingCancellation</td>
            <td>PENDING_CANCELLATION</td>
        </tr><tr>
            <td>rejected</td>
            <td>REJECTED</td>
        </tr>
...
<table id="T_MEFProductOrderItemStateType">
    <thead style="font-weight:bold;">
        <tr>
            <td>Value</td>
            <td>MEF 57.2</td>
    ...
    <tbody>
        <tr>
            ...
            <td>rejected.validated</td>
            <td>REJECTED.VALIDATED</td>
        </tr><tr>
            <td>rejected.unassessed</td>
            <td>REJECTED.UNASSESSED</td>
        </tr>
    </tbody>
</table>
...
<table id="T_ModifyProductOrderItemRequestedDeliveryDateStateChangeEvent" style="width:100%">
    ...
    <tbody>
        ...
        <td>event</td>
            <td><a href="#T_ModifyProductOrderItemRequestedDeliveryDateStateChangeEventPayload">ModifyProductOrderItemRequestedDeliveryDateStateChangeEventPayload</a></td>
            <td>M</td>
            <td>A reference to the object that is source of the notification.
</td>
            <td></td>
...
### 7.3.15. Type ModifyProductOrderItemRequestedDeliveryDateStateChangeEventPayload
...
<table id="T_MEFProductOrderChargeStateType">
    <thead style="font-weight:bold;">
        <tr>
            <td>Value</td>
            <td>MEF 57.2</td>
...
- [MEF 57.2.1](https://www.mef.net/wp-content/uploads/MEF-57.2.1-Draft-R1.pdf)
